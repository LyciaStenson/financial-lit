...
const PrivacyPolicyPage = () => {
    return ( 
        <div>
            <h1 className="pt-14 text-6xl text-white flex justify-center">
                Privacy Policy
            </h1>
            <p className="pt-14 px-16 text-md text-white">
                This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.
            </p>
            <p className="px-16 text-md text-white flex">
            ...
            <ul className="list-disc px-16 text-md text-white">
                <li>
                    refers to My Money Confidence, accessible from www.mymoneyconfidence.co.uk
                </li>
                <li>
