...
const Leaderboard=({placement, school, score, isUser}: Props)=>{
    return(
      ...
      <div className="w-72 h-20 rounded-2xl text-center flex-col flex items-center justify-between px-4 border-2 border-b-8 stripes stripes-size-[300px] stripes-opacity-30 stripes-white bg-moneyconf-gold py-2 text-moneyconf-purple border-moneyconf-purple">
