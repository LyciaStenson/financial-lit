...
const TermsAndConditionPage = () => {
    return (
        <div>
            <h1 className="pt-14 text-6xl text-white font-bold flex justify-center">
                Terms and Conditions
            </h1>
            <p className="pt-14 px-16 text-md flex justify-center text-white">
                Please read these terms and conditions carefully before using Our Service.
            </p>
            <h2 className="px-16 pt-14 text-4xl text-white flex justify-start">
                Interpretation and Definitions
            </h2>
            <h2 className="px-16 pt-2 text-4xl text-white flex justify-start">
                Interpretation
            </h2>
            <p className="px-16 pt-2 text-md text-white">
                ...
                <li>
                    <div className="flex flex-row">
                        <p className="text-md text-white">
                            refers to My Money Confidence, accessible from
                        </p>
                        <Link href={"mailto:info@mymoneyconfidence.co.uk"} className="text-white px-1 underline">
            ...
            <ul className="list-disc px-16 pb-20 text-md text-white">
                <li>
                    <div className="flex flex-row">
                        <p className="text-md text-white">
                            By email:
